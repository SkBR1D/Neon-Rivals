...
border_thickness = cell_size # Thickness of the border
...
player1_up = pygame.image.load('assets/sprites/player1up.png')
player1_down = pygame.image.load('assets/sprites/player1down.png')
player1_left = pygame.image.load('assets/sprites/player1left.png')
player1_right = pygame.image.load('assets/sprites/player1right.png')

player2_up = pygame.image.load('assets/sprites/player2up.png')
player2_down = pygame.image.load('assets/sprites/player2down.png')
player2_left = pygame.image.load('assets/sprites/player2left.png')
player2_right = pygame.image.load('assets/sprites/player2right.png')
...
class Main():
    ...
    def round_reset(self):
        ...
        self.speed_p.generate_position()
    ...
    def run_menu(self):
        ...
        while run:
            if self.menu_state == "Menu":
                ...
                menu.draw_text("Get your opponent to crash into your line or the border.", font_very_small,white, 100,400)
                ...
                menu.draw_text("P2 controls: up left right down arrows ", font_very_small,white, 100,700)
...
class Player1:
    ...
    def __init__(self, color, start_x, start_y):
        ...
        self.score = 0
        self.images = {
            pygame.K_UP: pygame.image.load('assets/sprites/player1up.png').convert_alpha(),
            pygame.K_DOWN: pygame.image.load('assets/sprites/player1down.png').convert_alpha(),
            pygame.K_LEFT: pygame.image.load('assets/sprites/player1left.png').convert_alpha(),
            pygame.K_RIGHT: pygame.image.load('assets/sprites/player1right.png').convert_alpha(),
        }
        self.direction = pygame.K_DOWN  # Default direction
...
class Player2:
    ...
    def __init__(self, color, start_x, start_y):
        ...
        self.score = 0
        self.images = {
            pygame.K_UP: pygame.image.load('assets/sprites/player2up.png').convert_alpha(),
            pygame.K_DOWN: pygame.image.load('assets/sprites/player2down.png').convert_alpha(),
            pygame.K_LEFT: pygame.image.load('assets/sprites/player2left.png').convert_alpha(),
            pygame.K_RIGHT: pygame.image.load('assets/sprites/player2right.png').convert_alpha(),
        }
        self.direction = pygame.K_DOWN  # Default direction
        self.image = self.images[self.direction]
        self.rect = self.image.get_rect()
